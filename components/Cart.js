...
const Cart = (props) => {
    ...
    const handleToken = async (token) => {
        ...
        if (status === "success") {
            dispatch({ type: 'EMPTY' });
            props.history.push('/');
            toast.success('You have paid successfully now you can continoue your shopping !', 
            ...
            {shoppingCart.length > 0 ? <div className="cart-summary">
                <div className="summary">
                    ...
                    <div className="stripe-section">
                        <StripeCheckout
                            stripeKey="pk_test_51LtyfvSIkHebNetk5O7L1czwtvSDQqS5eu28o6nk4pRvlH2Tj2K2GCepgRuACwUmG6hid3osVDPNptV6OXItdRqw00wzfvpTmw"
                            token={handleToken}
                            billingAddress
                            shippingAddress
